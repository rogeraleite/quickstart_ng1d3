...
///////////////////////////////// LINE chart ///////////////////////////////////
app.directive('cardiolc', function ($parse) {
      return {
         restrict: 'E',
         replace: true,
         template: '<div id="cardiolc"></div>',
         link: function (scope, element, attrs) {
                   var margin = { top: 5, right: 5, bottom: 20, left: 25 },
                            width = 380 - margin.left - margin.right,//380
                        ...
                        //d3.csv("assets/data/d3exportdata.csv", function(error, rawData) {
                                rawData.forEach(function(d) {
                                  ...
                                  d.cardio = +d.cardio;
                                  d.cardio_outlierness = +d.cardio_outlierness;                                                          //***************DIMENSION SETUP
                                  d.mvar_outlierness = +d.mvar_outlierness; 
                                });
...
.directive('meanso2lc', function ($parse) {
      return {
         restrict: 'E',
         replace: true,
         template: '<div id="meanso2lc"></div>',
         link: function (scope, element, attrs) {
                   var margin = { top: 5, right: 5, bottom: 20, left: 25 },
                        ...
                        //d3.csv("assets/data/d3exportdata.csv", function(error, rawData) {
                                rawData.forEach(function(d) {
                                  d.date = parseDate(d.date);
                                  d.meanso2 = +d.meanso2;
                                  d.meanso2_outlierness = +d.meanso2_outlierness;                                                          //***************DIMENSION SETUP
                                  d.mvar_outlierness = +d.mvar_outlierness;                                                        //***************DIMENSION SETUP
                                });
...
.directive('meanno2lc', function ($parse) {
      return {
         restrict: 'E',
         replace: true,
         template: '<div id="meanno2lc"></div>',
         link: function (scope, element, attrs) {
                   var margin = { top: 5, right: 5, bottom: 20, left: 25 },
                            width = 380 - margin.left - margin.right,
                            height = 250 - margin.top - margin.bottom;
                        ...
                        //d3.csv("assets/data/d3exportdata.csv", function(error, rawData) {
                                rawData.forEach(function(d) {
                                  d.date = parseDate(d.date);
                                  d.meanno2 = +d.meanno2;
                                  d.meanno2_outlierness = +d.meanno2_outlierness;                                                          //***************DIMENSION SETUP
                                  d.mvar_outlierness = +d.mvar_outlierness;  
                                });
...
.directive('meanpm10lc', function ($parse) {
      return {
         restrict: 'E',
         replace: true,
         template: '<div id="meanpm10lc"></div>',
         link: function (scope, element, attrs) {
                   var margin = { top: 5, right: 5, bottom: 20, left: 25 },
                            width = 380 - margin.left - margin.right,
                            height = 250 - margin.top - margin.bottom;
                        ...
                        //d3.csv("assets/data/d3exportdata.csv", function(error, rawData) {
                                rawData.forEach(function(d) {
                                  ...
                                  d.meanpm10_outlierness = +d.meanpm10_outlierness;                                                          //***************DIMENSION SETUP
                                  d.mvar_outlierness = +d.mvar_outlierness;  
                                });
                                ...
                                y.domain([d3.min(rawData, function(d){ return d.meanpm10; }),
                                                  d3.max(rawData, function(d){ return d.meanpm10; })])
...
.directive('meantemplc', function ($parse) {
      return {
         restrict: 'E',
         replace: true,
         template: '<div id="meantemplc"></div>',
         link: function (scope, element, attrs) {
                   var margin = { top: 5, right: 5, bottom: 20, left: 25 },
                            width = 380 - margin.left - margin.right,
                            height = 250 - margin.top - margin.bottom;
                        ...
                        //d3.csv("assets/data/d3exportdata.csv", function(error, rawData) {
                                rawData.forEach(function(d) {
                                  ...
                                  d.meantemp_outlierness = +d.meantemp_outlierness;                                                          //***************DIMENSION SETUP
                                  d.mvar_outlierness = +d.mvar_outlierness;                                                               //***************DIMENSION SETUP
                                });
...
.directive('meanhumilc', function ($parse) {
      return {
         restrict: 'E',
         replace: true,
         template: '<div id="meanhumilc"></div>',
         link: function (scope, element, attrs) {
                   var margin = { top: 5, right: 5, bottom: 20, left: 25 },
                            width = 380 - margin.left - margin.right,
                            height = 250 - margin.top - margin.bottom;
                        ...
                        //d3.csv("assets/data/d3exportdata.csv", function(error, rawData) {
                                rawData.forEach(function(d) {
                                  ...
                                  d.meanhumi_outlierness = +d.meanhumi_outlierness;                                                          //***************DIMENSION SETUP
                                  d.mvar_outlierness = +d.mvar_outlierness;    
                                });
...
///////////////////////////////// LINE cycle plot ///////////////////////////////////
.directive('cardiocp', function ($parse) {
      return {
         restrict: 'E',
         replace: true,
         template: '<div id="cardiocp"></div>',
         link: function (scope, element, attrs) {
                   var margin = { top: 5, right: 5, bottom: 20, left: 25 },
                            width = 380 - margin.left - margin.right,
                            height = 250 - margin.top - margin.bottom;
...
.directive('meanso2cp', function ($parse) {
        return {
           restrict: 'E',
           replace: true,
           template: '<div id="meanso2cp"></div>',
           link: function (scope, element, attrs) {
                     var margin = { top: 5, right: 5, bottom: 20, left: 25 },
                            width = 380 - margin.left - margin.right,
                              height = 250 - margin.top - margin.bottom;
...
.directive('meanno2cp', function ($parse) {
        return {
           restrict: 'E',
           replace: true,
           template: '<div id="meanno2cp"></div>',
           link: function (scope, element, attrs) {
                     var margin = { top: 5, right: 5, bottom: 20, left: 25 },
                            width = 380 - margin.left - margin.right,
                              height = 250 - margin.top - margin.bottom;
...
.directive('meanpm10cp', function ($parse) {
        return {
           restrict: 'E',
           replace: true,
           template: '<div id="meanpm10cp"></div>',
           link: function (scope, element, attrs) {
                     var margin = { top: 5, right: 5, bottom: 20, left: 25 },
                            width = 380 - margin.left - margin.right,
                              height = 250 - margin.top - margin.bottom;
                          ...
                          //d3.csv("assets/data/d3exportdata.csv", function(error, rawData) {
                                  ...
                                  svg.append("g")
                                          ...
                                          .attr("y", -5)
                                          .style("text-anchor", "middle")
                                          //.text("Mean PM10");                                                                                            //***************DIMENSION SETUP
...
.directive('meantempcp', function ($parse) {
        return {
           restrict: 'E',
           replace: true,
           template: '<div id="meantempcp"></div>',
           link: function (scope, element, attrs) {
                     var margin = { top: 5, right: 5, bottom: 20, left: 25 },
                            width = 380 - margin.left - margin.right,
                              height = 250 - margin.top - margin.bottom;
                          ...
                          //d3.csv("assets/data/d3exportdata.csv", function(error, rawData) {
                                  ...
                                  svg.append("g")
                                          ...
                                          .attr("y", -5)
                                          .style("text-anchor", "middle")
                                          //.text("Mean Temperature");                                                                                            //***************DIMENSION SETUP
...
.directive('meanhumicp', function ($parse) {
        return {
           restrict: 'E',
           replace: true,
           template: '<div id="meanhumicp"></div>',
           link: function (scope, element, attrs) {
                     var margin = { top: 5, right: 5, bottom: 20, left: 25 },
                            width = 380 - margin.left - margin.right,
                              height = 250 - margin.top - margin.bottom;
                          ...
                          //d3.csv("assets/data/d3exportdata.csv", function(error, rawData) {
                                  ...
                                  svg.append("g")
                                          ...
                                          .attr("y", -5)
                                          .style("text-anchor", "middle");
                                          //.text("Mean Humidity");                                                                                            //***************DIMENSION SETUP
